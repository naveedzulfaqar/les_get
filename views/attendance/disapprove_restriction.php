        ...
        <div class="container content">
            ...
            <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" id="approveotform"> 
                ...
                <div class="form-group"> 
                    <div class="col-lg-12">
                        <label> 
                            Disapproval Comment <span class="mandatory">*</span>
                        </label>
                ...
                <div class="form-group"> 
                    <div class="col-lg-2">
                        <?php if ($employee['ReportingTo'] == '' || $employee['ReportingTo'] == NULL) { ?>
                            <input type="button" name="approve_ot" id="approve_ot" class="btn btn-primary btn-lg btn-block" value="Disapprove <?php echo $type; ?>" style="font:menu; font-size:14px" onClick="validateForm()" disabled />
                            <p style="color:red"> Your Reporting To has not been assigned. Please contact your supervisor</p>
                        <?php } else {
                            ?>
                            <input type="button" name="approve_ot" id="approve_ot" class="btn btn-primary btn-lg btn-block" value="Disapprove <?php echo $type; ?>" style="font:menu; font-size:14px" onClick="validateForm()" />
            ...
            function validateForm() {
                ...
                if (error == 0) {
                    ...
                    $.post("", {ID: $("#ID").val(), EmployeeID: $("#EmployeeID").val(), Date: $("#Date").val(), ottype: $("#ottype").val(), comments: $("#comments").val()}, function (data) {
                        ...
                        if (url.indexOf("approvesr") != '-1') {
                            window.opener.document.getElementById("bttn_approve_sr").click();
                        }

                    ...
                    <table class="table table-striped table-bordered" width="50%" cellspacing="0">       
                        ...
                        <thead>
                            <tr class="trformat">
                                ...
                                <th class="thformat" <?php echo $style; ?>>Total Overtime</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr id="">
                ...
                <?php if ($ottype == '0') { ?>
                    <div class="form-group"> 
                        <div class="col-lg-12">
                            ...
                            <span class="form-control viewemployee" id="inputem3" style="height:auto; background-color: #F5F5F5"><?php echo $ot_approval_requests['OTComments']; ?></span>                        
                        </div>
                    </div>
                <?php } ?>
                <div class="form-group"> 
